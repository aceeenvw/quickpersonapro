    ...
    <div id="qpp-settings-panel" class="qpp-settings">
        <div class="inline-drawer">
            ...
            <div class="inline-drawer-content">
                <div class="qpp_settings_card">
                    <div class="qpp_settings_section">
                        <h4 class="qpp_settings_heading">${t`Behavior`}</h4>
                        <label class="qpp_set_row qpp_set_toggle">
                            <span class="qpp_set_text">
                                <span class="qpp_set_label">${t`Enable search bar`}</span>
                            </span>
                            <input type="checkbox" id="qpp-enableSearch" ${cfg.enableSearch ? 'checked' : ''}>
                        </label>
                        <label class="qpp_set_row qpp_set_toggle">
                            <span class="qpp_set_text">
                                <span class="qpp_set_label">${t`Enable keyboard navigation`}</span>
                            </span>
                            <input type="checkbox" id="qpp-enableKeyboardNav" ${cfg.enableKeyboardNav ? 'checked' : ''}>
                        </label>
                        <label class="qpp_set_row qpp_set_toggle">
                            <span class="qpp_set_text">
                                <span class="qpp_set_label">${t`Enable right-click context menu`}</span>
                            </span>
                    ...
                    <div class="qpp_settings_section">
                        <h4 class="qpp_settings_heading">${t`Display`}</h4>
                        <label class="qpp_set_row qpp_set_toggle">
                            <span class="qpp_set_text">
                                <span class="qpp_set_label">${t`Show lock indicators`}</span>
                            </span>
                            <input type="checkbox" id="qpp-enableLockIndicators" ${cfg.enableLockIndicators ? 'checked' : ''}>
                        </label>
                        <label class="qpp_set_row qpp_set_toggle">
                            <span class="qpp_set_text">
                                <span class="qpp_set_label">${t`Show persona name under each avatar`}</span>
                            </span>
                            <input type="checkbox" id="qpp-showPersonaName" ${cfg.showPersonaName ? 'checked' : ''}>
                        </label>
                        <label class="qpp_set_row qpp_set_toggle">
                            <span class="qpp_set_text">
                                <span class="qpp_set_label">${t`Show description preview in tooltip`}</span>
                            </span>
                            <input type="checkbox" id="qpp-showDescriptionTooltip" ${cfg.showDescriptionTooltip ? 'checked' : ''}>
                        </label>
                        <label class="qpp_set_row qpp_set_toggle">
                            <span class="qpp_set_text">
                                <span class="qpp_set_label">${t`Decorative glyphs`} ${GLYPH}</span>
                            </span>
                            <input type="checkbox" id="qpp-glyphInHeader" ${cfg.glyphInHeader ? 'checked' : ''}>
                        </label>
                        <div class="qpp_set_row">
                            <span class="qpp_set_text">
                                <span class="qpp_set_label">${t`Grid columns`}</span>
                                <span class="qpp_set_desc qpp-grid-auto-hint"></span>
                            </span>
                            <div class="qpp-control-cluster">
                        ...
                        <div class="qpp_set_row">
                            <span class="qpp_set_text">
                                <span class="qpp_set_label">${t`Menu placement`}</span>
                            </span>
                            <select id="qpp-menuPlacement" class="text_pole qpp_set_control">
                    ...
                    <div class="qpp_settings_section">
                        <h4 class="qpp_settings_heading">${t`Mobile`}</h4>
                        <label class="qpp_set_row qpp_set_toggle">
                            <span class="qpp_set_text">
                                <span class="qpp_set_label">${t`Show mobile quick-action toolbar`}</span>
                            </span>
                    ...
                    <div class="qpp_settings_section">
                        <h4 class="qpp_settings_heading">${t`Hotkey`}</h4>
                        <div class="qpp_set_block">
                            <label class="qpp_set_row qpp_set_toggle">
                                <span class="qpp_set_text">
                                    <span class="qpp_set_label">${t`Global hotkey`}</span>
                                </span>
                            ...
                            <div class="qpp-hotkey-row">
                                ...
                                <span class="qpp-muted qpp-hotkey-preview"></span>
                            </div>
                        </div>
                    </div>

                    <div class="qpp_settings_footer">
                        <button class="menu_button" id="qpp-reset">${t`Reset defaults`}</button>
                        <span class="qpp-muted">v${__QPP_PROV__.v} · ${__QPP_PROV__.a}${IS_TOUCH ? ' · 📱 touch' : ''}</span>
                    </div>
                </div>
            </div>
        </div>
